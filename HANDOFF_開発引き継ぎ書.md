...
最終更新時点の版：**v80** ／ 対象：`index.html`（単一ファイル）
...
- 実行：`PLAYWRIGHT_BROWSERS_PATH=/opt/pw-browsers python3 footpath_regression.py /path/to/index.html`（終了コード0＝全PASS。項目数は実行時に表示、現在**67項目**）。
...
*本書は v80 時点の内容です。以降の変更は本書と `ARCHITECTURE.md`・`APP_VERSION` を更新してください。*
