...
最終更新時点の版：**v84** ／ 対象：`index.html`（単一ファイル）
...
- 実行：`PLAYWRIGHT_BROWSERS_PATH=/opt/pw-browsers python3 footpath_regression.py /path/to/index.html`（終了コード0＝全PASS。項目数は実行時に表示、現在**101項目**）。
...
4. 印刷・配布用レイアウト（A4・凡例・縮尺・方位・説明）… 大／中
